...
- **Feature 4**: Theme Customizer & Presets. Added multi-accent styling options (Cyan, Purple, Emerald, Sapphire) to improve visual satisfaction. — Commit: [76aaa6a](https://github.com/Abhishek86038/remitflow-level5/commit/76aaa6a)
...
- **Feature 6**: Live Telemetry & Dev Console. Added a toggleable on-screen log terminal for tracking events and contract exceptions. — Commit: [962bc68](https://github.com/Abhishek86038/remitflow-level5/commit/962bc68)
- **Feature 7**: History Filters, Search & KPI widgets. Added status check tabs, transaction lookup search, and live volume/success rate trackers. — Commit: [848c143](https://github.com/Abhishek86038/remitflow-level5/commit/848c143)
...
| **Shreya** | `GASTVZNEON3OSJ5R5YOELNWY7O622OYZ74XWOEQJOUAFPFPDBWEM45US` | I'm trying to study how Soroban contracts execute under the hood. Opening browser developer tools to inspect events is a bit tedious. It would be amazing to have a toggleable log terminal or some telemetry feed right on the screen to see contract logs live!I | [`962bc68`](https://github.com/Abhishek86038/remitflow-level5/commit/962bc68) |
| **rohit kushwaha** | `GCSDJAMZ4JZWAY4RSF5PJILNZG7AJUUKICEBMUE2HDP56BUW6NLBUB4I` | really love the futuristic glow styling of the app! but can we get a theme switcher? the blue/cyan is cool but a dark purple or emerald green option would look super sick. | [`76aaa6a`](https://github.com/Abhishek86038/remitflow-level5/commit/76aaa6a) |
| **Ritesh kant** | `GALXUJI5TIYMUNPJT6Y3FEOYDCXSN3TP5KLRC5VRENJUKUNU67MN67WV` | the dashboard looks great, but could you display the network fee and estimated settlement time before we hit send? just a small estimator near the amount field would give peace of mind | [`b39ffe1`](https://github.com/Abhishek86038/remitflow-level5/commit/b39ffe1) |
| **Rishi Singh** | `GDTA4AJE34CXM4BUTPLQVBJYGOM2JZGGJ5TWH5RC6QZVU5H2KIQA4RZJ` | Pretty solid dApp! My history is getting quite long and it's hard to find specific transactions. A search box or quick filter buttons to separate pending escrows from released ones would be a huge lifesaver. | [`848c143`](https://github.com/Abhishek86038/remitflow-level5/commit/848c143) |
| **Ranjan mehta** | `GA5WQTVIO6XJWFML7VIOUS3JRWO3EVNA7J7S24K4MCW4OE3HYEAH357Z` | The compliance card shows my maximum limit, but it doesn't track how much I have sent overall. It would be really helpful to have a quick stats counter showing the total volume sent, active escrows, and a success rate so I can manage my monthly limits better. | [`8cbae7c`](https://github.com/Abhishek86038/remitflow-level5/commit/8cbae7c) |
| **Nitin Kapoor** | `GCADSJWNBJD7MBH5RY5HCYJH2DKMXOYZVJLTGLEOKSDFE2ZJE3ZXG74P` | Sometimes transactions take a few seconds on testnet and it feels like the app is frozen. A visual step-by-step tracker showing 'sent -> compliance checked -> locked in escrow -> released' would make the wait feel much shorter and reassuring. | [`4a76624`](https://github.com/Abhishek86038/remitflow-level5/commit/4a76624) |
| **Suraj Kumar** | `GBAKOBGSHZ5PORMNC5OKEGQQ7AVNCKBSYSFN436QNIO7MIEHCDDERZLH` | i noticed there is no easy way to clear my session logs or change wallets without clearing cache. Having a clear session state with instant pop-up notifications (like toasts) when a wallet connects or disconnects successfully would be a great UX polish n | [`e8292a3`](https://github.com/Abhishek86038/remitflow-level5/commit/e8292a3) |
