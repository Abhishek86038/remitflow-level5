...
| **Suraj Kumar** | `GBAKOBGSHZ5PORMNC5OKEGQQ7AVNCKBSYSFN436QNIO7MIEHCDDERZLH` | i noticed there is no easy way to clear my session logs or change wallets without clearing cache. Having a clear session state with instant pop-up notifications (like toasts) when a wallet connects or disconnects successfully would be a great UX polish | [`a42e772`](https://github.com/Abhishek86038/remitflow-level5/commit/a42e772) |
