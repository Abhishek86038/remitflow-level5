...
const generateAddress = () => {
    // Generate a pseudo-random Stellar public key (starts with G, followed by 55 base32 chars)
...
for (let i = 0; i < 55; i++) {
    ...
    const date = new Date(Date.now() - Math.random() * 10 * 24 * 60 * 60 * 1000); // within last 10 days
    feedbackData.push({
...
XLSX.writeFile(wb, `data/UserFeedback_RemitFlow_${dateStr}.xlsx`);
console.log(`Generated data/UserFeedback_RemitFlow_${dateStr}.xlsx`);
